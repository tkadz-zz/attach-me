...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item nav-category">Company Profile</li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#form-elementts" aria-expanded="false" aria-controls="form-elements">
                    <i class="menu-icon mdi mdi-account-multiple"></i>
                    <span class="menu-title">Company Profile</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="form-elementts">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="profileCompany.php">Profile</a></li>
        ...
        <li class="nav-item nav-category">Personal Profile</li>
        <li class="nav-item">
